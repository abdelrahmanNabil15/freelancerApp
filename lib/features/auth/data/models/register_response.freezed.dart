...
abstract class $RegisterResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? access, String? error});
}
...
class _$_RegisterResponse extends _RegisterResponse {
  const _$_RegisterResponse({this.id, this.access, this.error}) : super._();
  ...
  @override
  String toString() {
    return 'RegisterResponse(id: $id, access: $access, error: $error)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, access, error);
