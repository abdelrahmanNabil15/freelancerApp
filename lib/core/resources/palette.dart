...
class Palette {
  ...
  static const Color primary = Color(0xff8932a7);
  static const Color primaryLight = Color(0xffd176ff);
  ...
  static const Color greyShade400 = Color(0xff3d3d3d);
  ...
  static const Color gery10 = Color(0xffd3d3d3);
  ...
  static const  List<Color> colors=[primary,black,gery10,green,yellow,divider,red,primaryLight];
}
