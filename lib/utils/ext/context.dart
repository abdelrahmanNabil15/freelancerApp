...
extension ContextExtensions on BuildContext {
  ...
  Future<T?> navigateAndReturnData<T extends Object?>(BuildContext context, Widget destination) async {
  ...
  Future<void>  showWidget({required Widget  widget}) => showCupertinoModalPopup(
        context: this,
        barrierDismissible: false,
        builder: (c) {
          ctx = c;
